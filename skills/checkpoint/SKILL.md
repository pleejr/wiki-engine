...
- Deletion is a **guided in-session action** — confirm before removing. Pruning stays manual because it needs a human judgement about what is worth keeping, *not* because of recursion: no sentinel or concurrency bound makes an unattended delete correct. See the **Hard safety rule** in the engine's `CLAUDE.md`.
