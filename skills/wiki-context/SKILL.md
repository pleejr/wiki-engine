...
- **In-session, on demand; never from a lifecycle hook** (engine `CLAUDE.md`, Hard safety rule). The read path (steps 1–5) is ordinary work; the write path below needs a human.
