...
- **repo pages** additionally carry provenance for version-keyed refresh:
  ...
  sources:
    - repo: <name>
      ...
      ingested: <date>
  ```
- **project pages**: `type: project`, `status: active|paused|done`, `repos: [[...]]`; sections Goal · Linked repos · Key decisions (append-only) · Current state (overwritten each session) · Next steps. Chronological session work goes to `log.md`, tagged with the project.
